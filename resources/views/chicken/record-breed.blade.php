                        ...
                        <table class="table_egg">
                            <tbody>
                                <tr class="list_egg">
                                    ...
                                    <td class="brow3">A-2</td>
                                    <td class="brow4">15<samp> ฟอง</samp></td>
                                    <td class="brow5">13<samp> ฟอง</samp></td>
                                    <td class="brow6 table_button">
                                        <button class="edit" onclick="bred('1','A-2','15','13')">แก้ไข</button>
        ...
        <div class="popup_model">
            ...
            <form action="#" method="get">
                <div class="popup_content">
                    <p>คู่ผสม :</p>
                    <input type="text" name="inp" id="chicken-bred" class="inp">
                </div>
                <div class="popup_content">
                    <p>จำนวนไข่ :</p>
                    <input type="text" name="inp" id="egg-total" class="inp inp-num">
                    ฟอง
                </div>
                <div class="popup_content">
                    <p>ไข่มีเชื้อ :</p>
                    <input type="text" name="inp" id="bred-egg" class="inp inp-num">
                    ฟอง
                </div>
                <div class="event">
